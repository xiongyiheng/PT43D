...
class BaseOptions():
    ...
    def initialize(self):
        ...
        # log stuff
        self.parser.add_argument('--logs_dir', type=str, default='/mnt/raid/xiong/logs', help='models are saved here')
        self.parser.add_argument('--checkpoints_dir', type=str, default='./checkpoints', help='models are saved here')
        self.parser.add_argument('--name', type=str, default='experiment_name', help='name of the experiment. It decides where to store samples and models')

        # model stuff
        self.parser.add_argument('--model', type=str, default='pvqvae', choices=['pvqvae', 'pt43d'], help='chooses which model to use.')
        ...
        # transformer stuff
        self.parser.add_argument('--tf_cfg', type=str, default='configs/pt43d.yaml', help='tf model config file')
        ...
        self.parser.add_argument('--nThreads', default=12, type=int, help='# threads for loading data')
