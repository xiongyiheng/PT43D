...
ckpt="/mnt/raid/xiong/logs/2024-01-17T09-32-16-pvqvae-snet-all-LR1e-4-T0.2-clean_code/ckpt/vqvae_epoch-latest.pth" #'saved_ckpt/pvqvae-snet-all-LR1e-4-T0.2-rerun-epoch140.pth'
vq_note='default'
